"""Command-line interface for agentrl."""
...
def diagnose_cli():
    ...
    from agentrl.models import run_diagnostics
...
def compare_cli():
    ...
    from agentrl.models.checkpoints import recommend_checkpoint
    import json
...
def validate_resume_cli():
    ...
    from agentrl.models.checkpoints import validate_resume
    import json
...
def agent_diagnose_cli():
    ...
    from agentrl.agents import AgentRunLog, analyze_runs, to_preference_pairs
    import json
